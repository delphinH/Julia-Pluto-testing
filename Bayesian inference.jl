...
begin
	using CSV, HTTP, DataFrames, Random
...
md"""
### Let's see with a linear regression example
"""
...
# ╔═╡ 115341f3-7d46-456f-9d7a-3ed41fbdafcd
summarystats(chain)

# ╔═╡ c6e67570-ab0b-4213-8bbf-f9b0361ba802
mean(chain[:α])

# ╔═╡ 4e8a4bef-c071-4934-91b8-aee0416e342a
begin
	Random.seed!(12)
	alpha = 0.36
	beta = 0.00347
...
# ╔═╡ 23d7011f-514a-4eb5-a509-5db22e852b0e
mu = alpha .+ beta * (L_data .- mean(L_data))
...
git-tree-sha1 = "e0eef8106b34449a42ae521eb174683f710804a7"
